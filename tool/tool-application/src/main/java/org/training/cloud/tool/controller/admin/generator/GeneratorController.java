...
public class GeneratorController {
    ...
    @PreAuthorize("@ssc.hasPermission('tool:generator:create')")
    ...
    @PreAuthorize("@ssc.hasPermission('tool:generator:update')")
    ...
    @PreAuthorize("@ssc.hasPermission('tool:generator:list')")
    ...
    @PreAuthorize("@ssc.hasPermission('tool:generator:query')")
