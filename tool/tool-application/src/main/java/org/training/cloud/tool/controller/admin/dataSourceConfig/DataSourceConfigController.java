...
public class DataSourceConfigController {
    ...
    @PreAuthorize("@ssc.hasPermission('tool:dataSourceConfig:create')")
    ...
    @PreAuthorize("@ssc.hasPermission('tool:dataSourceConfig:update')")
    ...
    @PreAuthorize("@ssc.hasPermission('tool:dataSourceConfig:list')")
    ...
    @PreAuthorize("@ssc.hasPermission('tool:dataSourceConfig:delete')")
    ...
    @PreAuthorize("@ssc.hasPermission('tool:dataSourceConfig:query')")
